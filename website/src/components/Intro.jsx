...
export function Intro() {
  return (
    <>
      <h1 className="mt-14 text-center font-display text-4xl/none font-extrabold dark:text-white">
      ...
      <div className="mt-8">
        <p className="text-pretty py-4 text-center text-lg/6 font-medium dark:text-gray-300">
          Mount the engine into your Rails app and start managing your SQLite
          databases
        </p>
        <div className="flex flex-col   gap-2">
          <a
            ...
            className=" mx-auto mt-4 flex w-2/3 items-center  justify-center gap-2  rounded-lg border bg-slate-800 p-2 font-medium   text-gray-200  hover:scale-105 dark:border-gray-900 "
          >
          ...
          <a
            ...
            className="mx-auto mt-4 flex w-2/4 items-center justify-center gap-2  rounded-lg border bg-pink-700 p-1 font-medium text-gray-200 hover:scale-105 dark:border-gray-900 "
          >
            <svg
          ...
          <hr className="mx-auto my-8  w-2/3 dark:opacity-20" />

          <div>
            <h3 className="my-2 text-center font-semibold text-cyan-500">
              <a href="/guides/how-to-install-solid-litequeen-in-your-rails-app/">
