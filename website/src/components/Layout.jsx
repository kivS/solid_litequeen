...
function Glow() {
  ...
  return (
    <div className="absolute inset-0 -z-10 overflow-hidden lg:right-[calc(max(2rem,50%-38rem)+40rem)] lg:min-w-[32rem] dark:bg-gray-950">
      <svg
    ...
    <div className="relative flex-none overflow-hidden px-6 lg:pointer-events-none lg:fixed lg:inset-0 lg:z-40 lg:flex lg:px-0">
      ...
      <div className="relative flex w-full lg:pointer-events-auto lg:mr-[calc(max(2rem,50%-38rem)+40rem)] lg:min-w-[32rem] lg:overflow-y-auto lg:overflow-x-hidden lg:pl-[max(4rem,calc(50%-38rem))]">
        <div className="mx-auto max-w-lg lg:mx-0 lg:flex lg:w-96 lg:max-w-none lg:flex-col lg:before:flex-1 lg:before:pt-6">
          <div className="pb-16 pt-20 sm:pb-20 lg:pt-0  ">
...
export function Layout({ children }) {
  return (
    <>
      ...
      <ul className="z-50  mr-14 mt-4 flex justify-end p-[2px] text-sm">
        {/* <li>
					<Link
						href="/guides"
      ...
      <p className="z-10 -mb-11 mt-8 text-center text-sm font-semibold opacity-60 lg:-mb-20  lg:ml-auto lg:w-1/2 dark:font-extrabold">
        What's new?
      </p>
